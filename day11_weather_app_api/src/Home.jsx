...
import { DAY_TO_DAY_FORECAST, REALTIME_WEATHER_URL, WEATHER_API_KEY } from './api/ApiCall.jsx'
...
const Home = () => {
  ...
  return (
    <div className='container mx-auto bg-green-500 h-full rounded-b-2xl py-2'>
