...
const QuizComponent = ({quizData,result,handleTryAgain,resultName,setResultName,handleSave,showScore,highScore}) => {
  return (
    <>
      ...
      <Link to={"/"} className='px-4 py-2 text-white bg-gradient-to-tl from-pink-400 to-slate-400 hover:border-2 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none font-bold text-xl ' onClick={handleTryAgain}>Try again</Link>
