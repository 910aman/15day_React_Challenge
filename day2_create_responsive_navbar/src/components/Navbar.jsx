...
import companyLogo from '../assests/main_Iogo.png'
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          item.current ? 'bg-gray-900 text-white' : 'text-gray-300 data-[active]:bg-gray-900  hover:bg-gray-700 hover:text-white',
