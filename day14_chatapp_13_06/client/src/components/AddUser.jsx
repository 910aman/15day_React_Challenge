        ...
        <div className='flex h-screen justify-center items-center'>
            <div className='max-w-lg mh- w-full '>
                ...
                <div className="relative rounded-md shadow-sm">
                    <div className="relative left-0  flex items-center pl-3 w-5 h-5 ">
                    ...
                    <div className="absolute inset-y-0 right-0 top-5 flex items-center">
                        ...
                        <button onClick={() => { !userName == "" && setChatActive(true) }} className="h-9 rounded-md border bg-transparent py-0 px-4 flex items-center text-gray-100 focus:ring-2 focus:ring-inset !bg-[#423535]  focus:ring-indigo-600 sm:text-sm">
                            <p>Add User</p>
                        </button>
                    </div>
                </div>
