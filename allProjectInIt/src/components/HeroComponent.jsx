  ...
  return (
    <section className='flex flex-col xl:flex-row h-screen lg:justify-between'>
      <div className='pt-10 lg:pt-32 flex flex-col px-8 pb-10  items-start  text-white select-none'>
        ...
        <h1 className='lg:text-7xl sm:text-4xl flex flex-row sm:font-bold text-2xl font-semibold whitespace-nowrap z-50 mt-4'>
          I am &nbsp;
      ...
      <div className='max-w-lg min-w-[100px] h-[700px] mt-20 mr-60 w-full'>
        <img src={portraitHero} alt="Portrait Hero" className='h-full' />
      </div>
    </section>
  )
}
